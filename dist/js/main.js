...
(function (f) {
    if (typeof exports === "object" && typeof module !== "undefined") {
        ...
        System.registerDynamic("node_modules/ethers/dist/ethers.js", [], false, function ($__require, $__exports, $__module) {
        ...
        function r(e, n, t) {
            ...
            (function (global) {
                module.exports = function (length) {
                    var result = new Uint8Array(length);(global.crypto || global.msCrypto).getRandomValues(result);return result;
                };
            ...
            */
            ...
            var transactionFields = [{ name: 'nonce', maxLength: 32 }, { name: 'gasPrice', maxLength: 32 }, { name: 'gasLimit', maxLength: 32 }, { name: 'to', length: 20 }, { name: 'value', maxLength: 32 }, { name: 'data' }];
            ...
            var Wallet = /** @class */function (_super) {
                ...
                Wallet.prototype.sendTransaction = function (transaction) {
                    ...
                    if (tx.chainId == null) {
                        tx.chainId = this.provider.getNetwork().then(function (network) {
...
System.registerDynamic("src/ERC20ABI.json", [], false, function ($__require, $__exports, $__module) {
...
System.registerDynamic('src/index.js', ['ethers', './ERC20ABI.json'], true, function ($__require, exports, module) {
  ...
  */
  ...
  module.exports = function () {
    const ERC20ABI = $__require('./ERC20ABI.json');
...
System.registerDynamic('src/correntlynote.js', ['./index.js'], true, function ($__require, exports, module) {
  var global = this || self,
      GLOBAL = global;
  const CorrentlyNote = $__require('./index.js');
